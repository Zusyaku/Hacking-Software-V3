...
#Egyption Coderz
#Tool Finished In : 01:22 03/03/2022
#Tool Fixed in : idk yet LOL
...
<body>
	<center>
		...
		<font color="#f16f6f"><h1>[ ! ]Developped by RED [ ! ]</h1></font><br><br><br>
		...
		<center><img src="https://i.imgur.com/rpqs311.gif"/>
		</center><br><br><br>
		<font color="black" size="5" ><font color="red">Email :</font> admin@urlcut.online <br><br></font>
        <font color="black" size="5" ><font color="red">Email :</font><br><br></font>
		<font color="black" size="5" ><font color="red">Youtube :</font> <a href="https://www.youtube.com/channel/UCNqQxesaxBDkBPgaoTk1RpQ">Click</a><br><br></font>
		<h2>© RED 22</h2>
	</body>
	</html>\r\n.\r\n'''
			s.send(headers)
...
try:
 ...
 pass
save=open('about.txt','a').write('Hello \n https://t.me/ANON_PLUG JOIN US:) \n [+] Developped By RED \n [*] Youtube > https://www.youtube.com/channel/UCNqQxesaxBDkBPgaoTk1RpQ')
...
(.-./`-'\.-.)  \033[93m$$    $$/ $$ | $/  $$ |   $$ |   $$ |       \033[0;96m(.-./`-'\.-.) 
 `-'     `-'    \033[93m$$$$$$/  $$/      $$/    $$/    $$/         \033[0;96m`-'     `-'
              \033[91m[\033[92m+\033[91m]\033[1m  (C)opyright Xreactor       \033[91m [\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[95m SMTP CRACKER V2.1 BY REDX   \033[91m[\033[92m+\033[91m]
              \033[91m[\033[92m+\033[91m]\033[92m    https://xreactor.org/    \033[91m[\033[92m+\033[91m] ''')
...
if vers=='2.1':
 ...
 if ok=='1':
  ...
  os.system('git clone https://github.com/RED/Smtp-cracker && cd Smtp-cracker')
  if os.name=='nt':
   os.system('cls')
  else:
   os.system('clear')
